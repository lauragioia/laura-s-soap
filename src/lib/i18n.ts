...
const resources = {
  en: {
    translation: {
      ...
      "hero.subtitle": "Discover our natural cosmetics made with love",
  ...
  fr: {
    translation: {
      ...
      "hero.subtitle": "Découvrez nos cosmétiques naturels faits avec amour",
  ...
  it: {
    translation: {
      ...
      "hero.subtitle": "Scopri i nostri cosmetici naturali fatti con amore",
  ...
  de: {
    translation: {
      ...
      "hero.subtitle": "Entdecken Sie unsere natürlichen Kosmetika, hergestellt mit Liebe",
